...
export default function DataResult() {
  ...
  const groupDate = groupBy(Data, "batch_date");
  console.log(groupDate);
  
  // const dataTable = Object.keys(groupDate).map((data:any, i) => {
  //   console.log(groupDate[data][i])
  //   return (
  //     <tbody>
  //       <tr>
  //         <td>{i + 1}</td>
  //         <td>{groupDate[data][i]&&groupDate[data][i].lot_name}</td>
  //         <td>{data}</td>
  //         <td>{data}</td>
  //         <td>
