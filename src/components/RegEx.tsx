...
export const validLetterAndSpace = new RegExp("^[a-zA-Z]+$");

export const validNumberAndLetterAndSpace = new RegExp("^[a-zA-Z0-9 ]*$");

export const validNumber = new RegExp("^[0-9]+$");

export const validContractNumber = new RegExp("^[a-zA-Z]{2}[0-9]{5}$");

console.log(validLetterAndSpace.test("Jirakan"));
